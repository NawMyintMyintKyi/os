			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group row">
						<label>BrandID</label>
						<input class="form-control" type="text" name="brandid" value="{{$brand->brandid}}" >
				    </div>
				    <div class="form-group row">
						<label>Name</label>
						<input calss="form-control" type="text" name="name" value="{{$brand->name}}" class="form-control" >
					</div>
